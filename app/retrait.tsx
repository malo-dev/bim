...
const methods = [
  ...
  // { id: "africell", name: "AfriMoney", logo: "https://upload.wikimedia.org/wikipedia/commons/c/c9/AfricellLogo.png" },
   { id: "bim", name: "AgentBim", logo: "https://www.cit.fr/uploads/media/20944196.jpg" },
];
...
export default function RechargeEcoinsScreen() {
  ...
  const [createRetrait, { isLoading }] = useCreateRetraitMutation();
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const retraitResponse: any = await createRetrait({
      ...
      if (retraitResponse) {
        ...
        Alert.alert("Succès", `Retrait de ${amount} Ecoins réussie !`);

      } else {

        Alert.alert(
          "Échec",
          `Retrait échouée : "Erreur inconnue"}`
        );
      ...
      Alert.alert(
        "Erreur",
        err?.data?.message || "Une erreur est survenue lors de la retrait."
      );
    }
  };
        ...
        <View style={styles.container}>
          ...
          <LinearGradient colors={["#302E99", "#3906C7"]} style={styles.header}>
            <View style={styles.headerRow}>
              ...
              <Text style={styles.title}>Faire un retrait</Text>
